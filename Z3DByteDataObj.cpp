...
CZ3DByteDataObj::CZ3DByteDataObj(void)
{
	m_pBytes = NULL;
	m_lSize = 0;
	m_lReadPos = 0;
...
unsigned char *CZ3DByteDataObj::GetReadPtr() 
{
...
bool CZ3DByteDataObj::SaveByte(const char *strFileName,long lOffset )
{
...
bool CZ3DByteDataObj::LoadByte(const char *strFileName,long lOffset) 
{
...
long CZ3DByteDataObj::Write(void *ptr,size_t UnitSize,int iNum)
{
	if(ptr == NULL)
		return -1;
	return 0;
...
long CZ3DByteDataObj::Read(void *ptr,size_t UnitSize,int iNum)
{
	if(ptr == NULL)
		return -1;
